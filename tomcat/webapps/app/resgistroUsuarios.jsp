<%-- 
    Document   : resgistroUsuarios
    Created on : 19/10/2019, 03:43:14 AM
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <div>
                                            ...
                                            <form name="formUsuario" action="usuarioControl" method="POST" class="form-horizontal">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" name="nombre_titular" value="" placeholder="Titular">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label no-padding-right">
